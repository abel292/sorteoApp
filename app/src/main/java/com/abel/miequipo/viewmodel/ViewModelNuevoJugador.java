...
public class ViewModelNuevoJugador extends AndroidViewModel {
        ...
        public LiveData<List<JugadorEntitie>> getAllJugadores() { return listaJugadores; }

        public void insert(JugadorEntitie jugadorEntitie) { mRepository.insert(jugadorEntitie); }

        public void  deleteAllJugadores(){ mRepository.deleteAllJugadores();}
    }